        ...
        <form method="post" action="{{ route('register') }}" data-auth-form="register">
          ...
          <div class="step-panel active" id="step1">
            ...
            <div class="divider-row" style="margin: 20px 0; display: flex; align-items: center; gap: 10px;">
              <div class="divider-line" style="flex: 1; height: 1px; background: var(--gb-border);"></div>
              <span class="divider-txt" style="font-family: 'Press Start 2P', monospace; font-size: 8px; color: var(--gb-muted);">OU</span>
              <div class="divider-line" style="flex: 1; height: 1px; background: var(--gb-border);"></div>
            </div>

            <a href="{{ route('auth.google') ?? '/auth/google' }}" class="px-btn2" style="background: var(--gb-surface-2); color: var(--gb-text); border-color: var(--gb-border); margin-bottom: 24px; display: flex; align-items: center; justify-content: center; gap: 10px; text-decoration: none;">

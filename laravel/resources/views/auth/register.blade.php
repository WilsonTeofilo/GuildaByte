      ...
      <div class="os-body2">
        ...
        <form method="post" action="{{ route('register') }}" data-auth-form="register">
          ...
          <div class="step-panel active" id="step1">
            ...
            <a href="{{ url('/auth/google') }}" class="px-btn2" style="background: var(--gb-surface-2); color: var(--gb-text); border-color: var(--gb-border); margin-bottom: 24px; display: flex; align-items: center; justify-content: center; gap: 10px; text-decoration: none;">

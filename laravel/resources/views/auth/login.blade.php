  ...
  <main class="gb-root">
    ...
    <section class="os-window" aria-label="Login GuildaByte">
      ...
      <div class="os-body">
        ...
        {{-- Google Auth — integração via Socialite virá na Missão 15 --}}
        <div style="background: var(--gb-surface-2); border: 1px dashed #333; color: #555; padding: 12px; border-radius: 6px; font-family: 'Press Start 2P', monospace; font-size: 8px; text-align: center; margin-bottom: 16px; display: flex; align-items: center; justify-content: center; gap: 8px; cursor: not-allowed; opacity: 0.5;" title="Em breve!">

  ...
  <main class="gb-root">
    ...
    <section class="os-window" aria-label="Login GuildaByte">
      ...
      <div class="os-body">
        ...
        <a href="{{ route('auth.google') ?? '/auth/google' }}" class="px-btn" style="background: var(--gb-surface-2); color: var(--gb-text); border-color: var(--gb-border); margin-bottom: 24px; display: flex; align-items: center; justify-content: center; gap: 10px;">

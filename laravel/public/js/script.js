...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const selectPlan = (planKey) => {
        ...
        // Salvar localmente para usar na tela de auth
    ...
    if (authChoiceModal) {
        ...
        if (btnLogin) {
            btnLogin.addEventListener('click', () => {
                window.location.href = gbData ? gbData.routes.login : '/Guilda/login.php';
            });
        }

        if (btnRegister) {
            btnRegister.addEventListener('click', () => {
                window.location.href = gbData ? gbData.routes.register : '/Guilda/cadastro.php';
            });
        }
    }
});
